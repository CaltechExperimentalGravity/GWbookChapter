...
%It is illuminating to consider \emph{quantitatively} the amplitude of the noise for a few of these cases.
...
\begin{figure}
    ...
    \qquad
    \subfloat[Surf PSD]{{\includegraphics[width=5.5cm]{Figures/ETMpsd.pdf} }}
...
\subsection{Case I: The Beam Tube Baffles}
% based on T1300354
...
\subsection{Case II: The Test Mass Chambers}
...
\subsection{Backscatter from the Dark Port}
