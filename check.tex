...
%%
%% Utility to test if all the files required for WSPC book 9.75x6.5 project
...
\typeout{4. Searching for ws-crop975x65.sty ... }
\IfFileExists{ws-crop975x65.sty}
    {
     \typeout{  ... ok}
    }
    {
     \typeout{  ... ws-crop975x65.sty, file not found! }
     \typeout{ }
     \typeout{* Warning:}
     \typeout{*}
     \typeout{* The ws-crop975x65 file which is part of the WS Books distribution}
     \typeout{* must be installed in a directory which is searched by LaTeX.}
     \typeout{*}
     \typeout{* Without this package you will not be able to typeset }
     \typeout{* your book in 975x65 trim size.}
     \typeout{*}
     \typeout{*}
     \typein{* Type <return> to continue ...}
     \errortrue
